...
parser.add_argument("-m", "--modelpath", required=True, help="detection model path")
...
cmd = "python tools/test.py configs/mitotic/mitotic_{}_base.py {} --out {}".format(dataset, model_path, output_path)
os.system(cmd)
...
if(relocate_window):
    ...
    cmd = "python tools/test.py configs/mitotic/mitotic_{}_refocus.py {} --out {}".format(dataset, model_path, relocated_path)
    os.system(cmd)
