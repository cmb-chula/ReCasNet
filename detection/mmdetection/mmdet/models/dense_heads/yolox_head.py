...
class YOLOXHead(BaseDenseHead, BBoxTestMixin):
    ...
    def loss(self,
        ...
        ##############################
        # print(len(img_metas), bbox_preds[0][0][0][0], cls_scores[0][0][0][0])
        # print(len(img_metas), bbox_preds[0][0], cls_scores[0])
        ###########################
        ...
        # -->
        # flatten_bbox_preds += 1e-8
        ##############################
        # print(flatten_bbox_preds[0, :3], flatten_bbox_preds.min(), flatten_bbox_preds.max())
        ###########################
